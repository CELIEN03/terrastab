# Banque d'angles RGA — matière première pour la production
...
## 0. Le post de lundi : H'Expo

Décidé en réunion. Annonce de présence sur le stand, hashtags du salon, tag possible d'Action Logement et des autres bailleurs présents.
**Angle à privilégier :** le logement social est au cœur de la problématique RGA. Des locataires, pas des propriétaires. Quelqu'un qui subit les fissures sans pouvoir décider des travaux.
Post de clôture en fin de semaine, avec photo et retour de terrain. Demander à Philippe la liste des personnes rencontrées à mettre en avant.

---

## 1. Le sol vivant : la vulgarisation du mécanisme

C'est le cœur. Vulgariser le problème est autorisé et souhaitable. Vulgariser la solution ne l'est pas.
...
## 5. Assurance, CatNat, assurabilité

Le territoire le plus riche en actualité datée et sourçable.

| # | Angle | L'idée | Source |
|---|---|---|---|
| 5.1 | **L'Observatoire CatNat RGA** | Publier la série : communes demandeuses, reconnues, refusées, taux de refus, évolution. **L'actif propriétaire à créer** | ✅ arrêtés publics. Voir `positionnement-reference-rga.md` |
| 5.2 | Le décret et l'arrêté du 9 août 2026 | Qualification obligatoire des experts d'assurance. Lu à l'envers : jusqu'au 8 août, elle ne l'était pas | ⚠️ fait établi, références Légifrance à confirmer |
| 5.3 | Le Fonds de prévention à 5 mm | On appelle prévention un dispositif qui attend que la maison soit ouverte | ✅ |
| 5.4 | 2 000 dossiers déposés, 19 instruits | Le chiffre le plus dévastateur du corpus, s'il se confirme | ⚠️ à re-sourcer d'urgence |
| 5.5 | La sécheresse est devenue le premier poste CatNat | 53,1 % de la sinistralité non automobile sur dix ans. Inversion historique | ✅ rapport annuel CCR, 23/06/2026 |
| 5.6 | Les 500 milliards | Edouard Vieillefond, directeur général de la CCR : « risque principal » et « le plus fort en France » | ✅ attribution nommée obligatoire |
| 5.7 | Pertes assurées sécheresse 2025 | 770 M€ à 1 Md€ | ✅ CCR |
| 5.8 | La Cour de cassation change la donne | Arrêt du 12 février 2026 : une reconnaissance CatNat ne suffit plus, encore faut-il prouver que des mesures habituelles de prévention ont été prises | ⚠️ référence à confirmer |
| 5.9 | D'un sujet d'indemnisation à un sujet d'assurabilité | Le retournement le plus fort du corpus. À retravailler sans le chiffre erroné | ✅ |
| 5.10 | L'adresse devient un critère d'assurabilité | Sans retrait officiel de garantie, le prix et les conditions changent selon l'adresse | ✅ article rga-news 31/07 |
| 5.11 | Le délai de traitement | Le locataire ou le propriétaire vit avec les fissures pendant l'instruction | ⚠️ durée à sourcer |
| 5.12 | La franchise RGA | 1 520 € contre 380 € pour les autres périls CatNat | ✅ prompt système |
| 5.13 | Que faire quand une fissure apparaît | Ne pas reboucher. Photographier, dater, constituer le dossier. **Un post qui rend service et ne vend rien** | ✅ |
...
## 7. Patrimoine et humain

Le registre le plus distinctif du compte. Personne d'autre ne le tient sur le RGA.

| # | Angle | L'idée | Source |
|---|---|---|---|
| 7.1 | Le patrimoine ordinaire | Pas les châteaux et les cathédrales. Les villas des années 50, les écoles, les mairies, les maisons de famille | ✅ déjà amorcé, registre signature |
...
## 9. Formats et rendez-vous à installer

| # | Format | Ce que c'est | Statut |
|---|---|---|---|
...
## 10. Les mécanismes de vulgarisation à réutiliser

Repris du playbook Jancovici et adaptés au RGA.

| Mécanisme | Application RGA |
|---|---|
| **L'ordre de grandeur plutôt que le chiffre exact** | Dire « trois maisons individuelles sur cinq » plutôt que « 12,1 millions ». Le rapport se retient, le chiffre s'oublie et se conteste |
| **L'unité incarnée** | « Une douche quotidienne, environ 30 litres par jour » pour l'eau utilisée. Déjà sur le site, **jamais sur LinkedIn** |
| **Le cadre physique irréfutable** | « Le sol bouge. La maison, elle, ne peut pas. » Personne ne conteste ça, tout en découle |
| **Cinq portes pour le même problème** | Pourquoi ma maison se fissure : angle climatique, géologique, facteurs aggravants, assurantiel, réglementaire. Un post, une porte, jamais deux fois la même |
| **Le chiffrage par cas concret** | Construire un parc devant le lecteur : 500 logements, 60 % sur argile, donc 300 exposés. Le calcul se fait sous ses yeux |
| **Le raisonnement visible** | Montrer la chaîne causale, pas la conclusion |

---

## 11. Rappels de sécurité, à chaque post

- Le problème se vulgarise. **La solution, jamais.**
- Le sol se stabilise. **Les fondations, jamais.** Formulation de référence, post du 15/05 : « D'abord stabiliser le sol. Ensuite, si nécessaire, conforter les fondations. »
- **Préventif ET curatif.** Ne jamais écrire « empêche les fissures d'apparaître » seul.
- **Aucun prix brut.** Des ratios.
- **Aucun chiffre sans source nommée**, et validation de Philippe sur WhatsApp.
- **Pas de comparaison avec d'autres approches** sans cadrage préalable de Philippe et Stéphane.
